...
class MemoryTrace(object):
    ...
    def __init__(self, filename, max_look_ahead=int(1e4), cache_line_size=64):
        ...
        Args:
          ...
          max_look_ahead (int): number of load calls to look ahead in 	## 看多遠
        ...
        self._access_times = collections.defaultdict(collections.deque) ## double-ended queue
        self._look_ahead_buffer = collections.deque()
        self._offset_bits = int(np.log2(cache_line_size)) ## 6
